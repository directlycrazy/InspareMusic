			...
			<div className="mt-5">
				{subtitle && <>
					...
					<button
						...
						style={{ height: 60, width: 60 }}
						onClick={shuffle}
						className="inline-flex items-center rounded-full hover:bg-zinc-100 dark:hover:bg-zinc-600 px-3 py-2 text-sm font-semibold text-black dark:text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
					>
