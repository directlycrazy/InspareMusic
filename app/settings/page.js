			...
			>
				...
				<div className="sm:col-span-3 mt-3">
					...
					<div className="mt-2">
						<select
							defaultValue={3}
							className="block w-full rounded-md border-0 p-2 bg-white dark:bg-zinc-700 text-zinc-900 dark:text-white shadow-sm ring-1 ring-inset ring-zinc-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
						>
